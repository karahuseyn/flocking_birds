...
# Grand total: 120/1000 ARC training, 0/120 ARC-2 evaluation. Progression: 8 -> 36 -> 53 -> 59 -> 62 -> 68 -> 93 -> 96 -> 98 -> 111 -> 116 -> 120. Two findings: (1) growing the vocabulary helps ONLY along a genuinely new
...
def solve(task):
    for mod, arg in ((L, 2), (PA, None), (WF, None), (FR, None), (CB, None), (OS, None), (SR, None), (ORU, None), (MO, None), (RY, None)):
